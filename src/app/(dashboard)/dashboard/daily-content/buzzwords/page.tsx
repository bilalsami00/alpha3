// // // // src\app\(dashboard)\dashboard\daily-content\buzzwords\page.tsx
// // // "use client";
...
// // // import AddEditItem from "../AddEditItem"; // reuse the same modal UI
...
// // // Named export: the component that accepts the config prop
...
// // // Default page export (no props) — satisfies Next.js route requirement
...
// // LOCAL component (not exported) — prevents Next from seeing extra page exports
// function Buzzwords({
//   emptyStateConfig,
// }: {
//   emptyStateConfig?: EmptyStateConfig;
...
// // SINGLE allowed default export for Next page — forward props to the local component
// export default function Page({ emptyStateConfig }: { emptyStateConfig?: EmptyStateConfig }) {
//   return <Buzzwords emptyStateConfig={emptyStateConfig} />;
// }
...
export default function Page() {
  // Page-level default content — no custom props
  return <Buzzwords />;
}
