...
// // // // //   // Body lock for mobile sidebar only (preserves scroll position)
// // // // //   useEffect(() => {
// // // // //     let removeTouchListener = () => {};
...
// // // // //       <aside
// // // // //         ref={sidebarRef}
// // // // //         className={`fixed lg:static lg:h-full inset-y-0 left-0 z-50 w-64 bg-white border-r border-neutral-200 transform transition-transform duration-300 ease-in-out ${
// // // // //           sidebarOpen ? "translate-x-0" : "-translate-x-full"
// // // // //         } lg:translate-x-0 flex flex-col`}
// // // // //         aria-hidden={!sidebarOpen}
// // // // //       >
...
// // // // //           {/* NAV - scrollable area */}
// // // // //           <nav
// // // // //             className="mt-4 overflow-y-auto flex-1 min-h-0 custom-scroll"
// // // // //             style={{ WebkitOverflowScrolling: "touch" }}
// // // // //           >
// // // // //             <ul className="space-y-2 px-1 pb-4">
// // // // //               {menuItems.map((item) => {
...
// // // // //           {/* footer / logout anchored to bottom */}
...
// // // //       <aside
// // // //         ref={sidebarRef}
// // // //         className={`fixed lg:static h-screen inset-y-0 left-0 z-50 w-64 bg-white border-r border-neutral-200 transform transition-transform duration-300 ease-in-out ${
// // // //           sidebarOpen ? "translate-x-0" : "-translate-x-full"
// // // //         } lg:translate-x-0 flex flex-col`}
// // // //         aria-hidden={!sidebarOpen}
// // // //       >
...
// // //       {/* Sidebar
// // //           - fixed on small screens (overlay)
// // //           - sticky top-0 on lg screens (in-flow, pinned)
// // //           - do NOT force h-screen here; let the inner wrapper control sizing via min-h-screen
// // //       */}
// // //       <aside
// // //         ref={sidebarRef}
// // //         className={`fixed lg:sticky lg:top-0 inset-y-0 left-0 z-50 w-64 bg-white border-r border-neutral-200 transform transition-transform duration-300 ease-in-out ${
// // //           sidebarOpen ? "translate-x-0" : "-translate-x-full"
// // //         } lg:translate-x-0 flex flex-col`}
// // //         aria-hidden={!sidebarOpen}
// // //       >
// // //         {/* inner wrapper: make it at least viewport tall so mt-auto pushes footer to bottom */}
// // //         <div className="flex flex-col min-h-screen 2xl:py-6 px-3">
// // //           {/* logo/header */}
// // //           <div className="flex-shrink-0 flex justify-center pt-2">
// // //             <Image src="/authIcons/Alpha-logo.png" alt="Alpha Logo" width={96} height={96} className="h-24 w-24" />
// // //           </div>
...
// //       <aside
// //         ref={sidebarRef}
// //         className={`fixed lg:relative xl:sticky lg:top-0 left-0 z-50 w-64 bg-white border-r border-neutral-200 transform transition-transform duration-300 ease-in-out ${
// //           sidebarOpen ? "translate-x-0" : "-translate-x-full"
// //         } lg:translate-x-0 flex flex-col`}
// //         aria-hidden={!sidebarOpen}
// //       >
// //         {/* inner wrapper: use flex-col and let parent determine height; min-h-screen optional */}
// //         <div className="flex flex-col h-screen 2xl:py-6 px-3">
// //           {/* logo/header */}
// //           <div className="flex-shrink-0 flex justify-center pt-2">
// //             <Image src="/authIcons/Alpha-logo.png" alt="Alpha Logo" width={96} height={96} className="h-24 w-24" />
// //           </div>
...
export default function SidebarClient() {
  ...
  // start closed by default so refresh/navigation does NOT open it
  ...
  useEffect(() => {
    const checkScreenSize = () => {
      const mobile = window.innerWidth < 1024;
      // only update isMobile — do NOT auto-open/close sidebar here
      setIsMobile(mobile);
    };
  ...
  // Close sidebar on route change (always) — ensures navigation closes it
  useEffect(() => {
