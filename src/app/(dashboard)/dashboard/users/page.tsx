...
export default function Users() {
  ...
  const requestColumns: Column<User>[] = [
    ...
    },
    {
      ...
      header: "Phone number",
      width: "240px",
      className: "  max-2xl:!px-1",
      accessor: (user) => <div className=" w-full"> { user.phone ?? "-" } </div>
    },
    {
      key: "reason",
      header: "Why do you want to do sales ?",
      width: "524px",
      className: " max-2xl:!px-5",
      render: (user) => (
        <div
          className=" max-xl:w-[160px]  max-2xl:max-w-[400px] [@media(min-width:1600px)]:max-w-[524px] overflow-hidden whitespace-nowrap text-ellipsis"
          title={user.salesReason ?? ""}
        >
          {user.salesReason ?? ""}
        </div>
    ...
    },
    {
      ...
      header: "Action",
      width: "100px",
      className: "max-2xl:!pr-8 max-2xl:!pl-0",
      align: "center",
      render: (user) => (
        <button
          type="button"
