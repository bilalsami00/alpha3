...
//   // after registerMenuRef
// useEffect(() => {
//   if (openMenuId == null) return;

//   // small delay so the menu has actually mounted & layout is stable
//   const id = window.setTimeout(() => {
//     const menuEl = menuRefs.current[openMenuId];
//     if (!menuEl) return;

//     // scroll the *page* so the menu is visible (nearest avoids jumping too far)
//     try {
//       menuEl.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "nearest" });
//     } catch (err) {
//       // fallback: scroll the window to the menu's top if scrollIntoView isn't supported
//       const rect = menuEl.getBoundingClientRect();
//       const absoluteTop = window.scrollY + rect.top;
//       window.scrollTo({ top: absoluteTop - 80, behavior: "smooth" }); // -80 to give a little top padding
//     }
//   }, 0);
...
//       render: (user) => (
//         <div
//           className=" max-xl:w-[150px] max-2xl:max-w-[400px] [@media(min-width:1600px)]:max-w-[524px] overflow-hidden whitespace-nowrap text-ellipsis"
...
//       <div className="bg-white rounded shadow-s m overflow-visible">
//         {/* Table */}
//         <GenericTable<User>
      ...
      render: (user) => (
        <div className="flex justify-center">
          <RowActionMenu
            ...
            wrapperClassName=""
            menuWidthClass="w-40 max-w-[175px]"
            // provide children so we render Restrict/Delete instead of Edit/Delete
          >
            <button
              onClick={() => {
