...
//       {/* NOTE: changed parent wrapper: keep overflow-visible if your table rows were clipping */}
...
// /* Actions cell: three-dots menu with Edit / Remove (uses PiDotsThreeOutline).
//    Behavior:
//    - menu is absolutely positioned relative to the wrapper (no measuring/flipping)
//    - when opened we call scrollIntoView on the menu so the *page* scrolls to reveal it
// */
// function ActionsCell({
//   row,
//   onEdit,
...
//   // when open, scroll the menu (or wrapper) into view so the page scrolls (not the table)
//   useEffect(() => {
//     if (!open) return;
//     const t = window.setTimeout(() => {
//       const wrapper = menuRef.current;
//       if (!wrapper) return;
//       // prefer the menu element if present
