...
//     // wait one tick so the menu DOM has mounted
//     const tid = window.setTimeout(() => {
//       // prefer the portal element (data-row) if present
//       const portalMenu = document.querySelector(`[data-action-menu][data-row="${openMenuId}"]`) as HTMLElement | null;
//       if (portalMenu) {
//         try {
//           portalMenu.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "nearest" });
//           return;
//         } catch {}
//       }
...
//             <RowActionMenu
//               id={m.id}
//               ariaLabel={`Member actions for ${m.fullName}`}
//               menuWidthClass="w-44 max-w-[175px]"
//               wrapperClassName=""
//               onOpen={() => setOpenMenuId(m.id)}
//               onClose={() => setOpenMenuId((cur) => (cur === m.id ? null : cur))}
//             >
//               <div className="py-1">
//                 <button
//                   onClick={() => {
//                     setConfirm({ open: true, member: m, type: "remove" });
//                     setOpenMenuId(null);
//                   }}
//                   className="flex items-center w-full h-[44px] text-left px-4 py-2 txt-14 hover:bg-gray-100 rounded-t-lg border-b border-[var(--Neutral-Grey-10,#E9EDEE)]"
//                 >
...
//                 <button
//                   onClick={() => {
//                     setConfirm({ open: true, member: m, type: "restrict" });
//                     setOpenMenuId(null);
//                   }}
//                   className="flex items-center w-full h-[44px] text-left px-4 py-2 txt-14 hover:bg-gray-100 border-b border-[var(--Neutral-Grey-10,#E9EDEE)]"
//                 >
...
//                 <button
//                   onClick={() => {
//                     setConfirm({ open: true, member: m, type: "delete" });
//                     setOpenMenuId(null);
//                   }}
//                   className="flex items-center w-full h-[44px] text-left px-4 py-2 txt-14 hover:bg-gray-100 rounded-b-lg"
//                 >
  ...
  useEffect(() => {
    ...
    const tid = window.setTimeout(() => {
      ...
      const portalMenu = document.querySelector(
        `[data-action-menu][data-row="${openMenuId}"]`
      ) as HTMLElement | null;
      if (portalMenu) {
        try {
          portalMenu.scrollIntoView({
            behavior: "smooth",
            block: "nearest",
            inline: "nearest",
          });
        ...
        <div className="flex justify-center">
          ...
          >
            <RowActionMenu
              ...
              onOpen={() => setOpenMenuId(m.id)}
              onClose={() =>
                setOpenMenuId((cur) => (cur === m.id ? null : cur))
              }
            >
              <div className="py-1">
                <button
