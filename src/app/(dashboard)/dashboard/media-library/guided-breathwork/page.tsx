// // src/app/(dashboard)/dashboard/components/MediaLibrary/GuidedBreathwork/index.tsx
// "use client";
...
// export default function GuidedBreathworkPage({
//   emptyStateConfig,
// }: {
//   emptyStateConfig?: {
//     icon?: string;
...
//   };
// }) {
//   const category = "Guided Breathwork";

//   const displayTitle = "No Guided Breathwork Sessions Yet";
...
//         <div>
//           {/* show top Add only when there are items */}
//           {items.length > 0 && (
//             <button
//               onClick={openAdd}
...
//               // title={emptyStateConfig?.title ?? category}
//               title={emptyStateConfig?.title ?? displayTitle}
//               subtitle={
//                 emptyStateConfig?.subtitle ??
//                 // `No ${category.toLowerCase()} items yet.`
//                 `Start by uploading your first video to help your team relax, reset, and stay focused throughout the day.`
//               }
//               action={emptyAction}
//             />
//           }
...
export default function Page() {
  // Page-level default export (no custom props)
  return <GuidedBreathwork />;
}
