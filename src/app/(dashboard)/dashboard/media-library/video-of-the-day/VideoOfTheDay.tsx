// // src\app\(dashboard)\dashboard\media-library\video-of-the-day\VideoOfTheDay.tsx
// "use client";
...
//   };
// }) {
//   const category = "Video of the Day";
//   const displayTitle = "No Video of the Day Uploaded";
...
//                 `Upload today’s featured video to keep your team inspired and motivated with daily content.`
//               }
//               action={emptyAction}
//             />
//           }
...
//         description="This action cannot be undone. The video will be permanently removed from video of the day sessions."
//         intent="danger"
//         confirmLabel="Delete"
...
export default function VideoOfTheDay({
  ...
  function openEdit(item: MediaItem) {
    setModalMode("edit");
    // lookup fresh item from state to avoid stale reference
